...
@foreach($my_apartment_details as $data)
    ...
    <div id = "avail-modal" class = "modal">
        <div class = "modal-content">
            <span class="close" id = "close-avail">x</span>
        </div>
    </div>

    <div id="booking-modal" class="modal">
        <div class="modal-content">
            <span class="close" id = "close-book">x</span>
    ...
    <script>
        $(document).ready(function(){
            ...
            var modalr = document.getElementById('rating-modal');
            var modala = document.getElementById('avail-modal');
            var btn = document.getElementById("booking-modal-button");
            var btnr = document.getElementById("rating-modal-button");
            var btna = document.getElementById("avail-modal-button");
            var span = document.getElementById("close-book");
            var spanr = document.getElementById("close-rate");
            var spana = document.getElementById("close-avail");
