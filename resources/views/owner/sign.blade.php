...
<html>
    <head>
        <script src=â€?//ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.jsâ€?></script>
        <link rel=â€?stylesheetâ€? id=â€?font-awesome-cssâ€? href=â€?//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.cssâ€? type=â€?text/cssâ€? media=â€?screenâ€?>
        <style>
            .top-container{
                height: 110px;
            ...
            <div class = "main-container">
                <div class = "container">
                    <div class = "top-text">
                        ...
                        {!! Form::open(array('route' => 'sign-up.owner', 'method' => 'post', 'files'=>true, 'before' => 'csrf' )) !!}
